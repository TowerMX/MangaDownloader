...
DRIVER_BASE_FOLDER_NAME = "driver"
DRIVER_BASE_FOLDER_PATH = os.path.join(ROOT_PATH, DRIVER_BASE_FOLDER_NAME)

WINDOWS_FOLDER = "win"
WINDOWS_DRIVER = "chromedriver.exe"

WINDOWS_FOLDER_PATH = os.path.join(DRIVER_BASE_FOLDER_PATH, WINDOWS_FOLDER)
WINDOWS_DRIVER_PATH = os.path.join(WINDOWS_FOLDER_PATH, WINDOWS_DRIVER)

# MACOS_FOLDER = "macos"
# MACOS_DRIVER = "chromedriver.app"
#
# MACOS_FOLDER_PATH = os.path.join(DRIVER_FOLDER_PATH, MACOS_FOLDER)
# MACOS_DRIVER_PATH = os.path.join(MACOS_FOLDER_PATH, MACOS_DRIVER)

LINUX_FOLDER = "linux"
LINUX_DRIVER = "chromedriver"

LINUX_FOLDER_PATH = os.path.join(DRIVER_BASE_FOLDER_PATH, LINUX_FOLDER)
...
def recalculatePaths(root_path):
    global ROOT_PATH, DRIVER_BASE_FOLDER_PATH, LINUX_FOLDER_PATH, LINUX_DRIVER_PATH, WINDOWS_FOLDER_PATH, WINDOWS_DRIVER_PATH, LOG_FOLDER
